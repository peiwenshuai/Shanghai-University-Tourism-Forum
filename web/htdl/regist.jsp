...
<head>
    ...
    <%
        if(request.getSession().getAttribute("message_r")!=null)
        {
            out.println("<script type=\"text/javascript\" language=\"javascript\">\n" +
                    "alert(\""+request.getSession().getAttribute("message_r")+"\");\n" +
    ...
    <div class="cd-user-modal-container" >
        ...
        <form class="cd-form " action="/regist" method="post" >
            ...
            <p class="fieldset">
                ...
                <input class="full-width has-padding has-border"name="username" id="sigin-name" type="text" placeholder="请输入账户名">
            ...
            <p class="fieldset">
                ...
                <input class="full-width has-padding has-border" name="password2" id="signup-password2" type="password"  placeholder="请再次输入密码">
                <span class="cd-error-message">格式错误!</span>
                <!--  <a style="
                          display: inline-block;
                          position: absolute;
            ...
            <!-- <p class="fieldset">
             ...
             -->
            <p class="fieldset">
                <label class="image-replace cd-username" >电子邮箱</label>
                <input class="full-width has-padding has-border"name="email" id="sigin-email" type="text" maxlength="30" placeholder="电子邮箱">
                <span class="cd-error-message">电子邮箱名错误</span>
            </p>
            <p class="fieldset">
                ...
                <a style="
                          ...
                          bottom: -22px;
                          font-size: 14px;
                          color: #3277fc;" href="htdl/login.jsp">登录</a>
                <a style="
                          display: inline-block;
                          position: absolute;
                          right: 90px;
